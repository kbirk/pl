...
PLbool plMeshAlgorithm::_splitEdgeOnVect( const plMeshConnectivityDataEdge* edgeAB, const plMeshConnectivityDataVert* vertN, PLuint verbose, PLuint depth )
{
    ...
    edgeANInsert.originatingMesh = edgeAB->originatingMesh;
    ...
    edgeNBInsert.originatingMesh = edgeAB->originatingMesh;
    ...
    vertA->edges.add(edgeAN);
    vertB->edges.add(edgeNB);
    ...
    {
        std::cout << "Splitting face " << facesToSplit[i] << std::endl;
        // find all existing cells, have them available in case they're needed later
        ...
        edgeNCInsert.originatingMesh = edgeAB->originatingMesh;
        ...
        faceANCInsert.originatingMesh = edgeAB->originatingMesh;
        faceBNCInsert.originatingMesh = edgeAB->originatingMesh;
        ...
        vertC->faces.remove(vertC->faces.findIndex(faceABC));
...
PLbool plMeshAlgorithm::_splitFaceOnVect( const plMeshConnectivityDataFace* face012, const plMeshConnectivityDataVert* vertN, PLuint verbose, PLuint depth )
{
    ...
    edgeN0Insert.originatingMesh = face012->originatingMesh;
    ...
    edgeN1Insert.originatingMesh = face012->originatingMesh;
    ...
    edgeN2Insert.originatingMesh = face012->originatingMesh;
    ...
    face01NInsert.originatingMesh = face012->originatingMesh;
    ...
    face12NInsert.originatingMesh = face012->originatingMesh;
    ...
    face20NInsert.originatingMesh = face012->originatingMesh;
...
PLbool plMeshAlgorithm::_importTriSeq(const plSeq<plTriangle> &tris, PLuint originatingMesh, PLuint verbose, PLuint depth )
{
    if (verbose >= PL_LOGGER_LEVEL_DEBUG) {
        for (PLuint i=0;i<depth;i++)
            std::cout << "\t";
    ...
    for (PLuint i = 0; i < tris.size(); i++)
    {
        ...
        vert0Insert.originatingMesh = 0; // vertex originating mesh doesn't matter.
        ...
        edge01Insert.originatingMesh = originatingMesh;
        ...
        edge12Insert.originatingMesh = originatingMesh;
        ...
        edge20Insert.originatingMesh = originatingMesh;
        ...
        face012Insert.originatingMesh = originatingMesh;
