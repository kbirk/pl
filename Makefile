...
SOURCES = main.cpp PlannerWindow.cpp pl.cpp plAutomaticPlanner.cpp plBoneAndCartilage.cpp plBoundary.cpp \
	      ...
	      plSpline.cpp plString.cpp plTexture2D.cpp plTexture2DMesh.cpp plTexture2DShader.cpp plTexture3D.cpp plTexture3DMesh.cpp plTexture3DShader.cpp plTrackedObject.cpp \
