...
SOURCES = main.cpp pl.cpp PlannerWindow.cpp plBoundary.cpp plBoundaryEditor.cpp \
	...
	plMesh.cpp plModel.cpp plPickingTexture.cpp plPlan.cpp plPolygon.cpp plProjection.cpp plRenderable.cpp \
