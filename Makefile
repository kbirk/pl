...
SOURCES = main.cpp PlannerWindow.cpp plBoneAndCartilage.cpp plBoundary.cpp plBoundaryEditor.cpp \
	...
	plDonorSite.cpp plDraw.cpp plEditable.cpp plGraft.cpp plGraftEditor.cpp plIGuide.cpp plMath.cpp plMatrix44.cpp \
	plMatrixStack.cpp plMesh.cpp plModel.cpp plPickingTexture.cpp plPlan.cpp plPlug.cpp plPolygon.cpp plProjection.cpp plRenderable.cpp \
	plRenderer.cpp plRenderingPipeline.cpp plSpline.cpp plString.cpp plTransform.cpp plTriangle.cpp plVector3.cpp \
